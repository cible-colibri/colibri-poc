...
def test_project():
    ...
    #p.connect("duct-1", "flow", "duct-2", "flow")
    #p.connect("duct-1", "temperature", "duct-2", "temperature")
    # or:
    ...
    # or:
    #st.height_fraction_of_thermostat_2 = 0.5

    p.connect("duct-2", "flow", "storage tank-1", "Inlet temperature for port-1")
