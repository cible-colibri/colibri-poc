"""
Tests for the `limited_generator.py` module.
"""
...
def test_limited_generator() -> None:
    """Test the LimitedGenerator class."""
    generator: LimitedGenerator = LimitedGenerator(
        name="generator-1",
    )
    ...
    assert isinstance(generator, LimitedGenerator) is True
