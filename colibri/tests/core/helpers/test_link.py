...
def test_links():
    ...
    assert link_1.__str__() == "Link(from_model=Duct(name = 'duct_1'), from_variable='inlet_temperature', to_model=Duct(name = 'duct_2'), to_variable='outlet_temperature', index_from=None, index_to=None)"
