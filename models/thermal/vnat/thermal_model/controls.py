...
def search_heatflux_spaces(hvac_flux, op_mode, setpoint, Ad, Bd, states_0, U, index_states, index_inputs, rad_share_hvac, radiative_share_sensor, ventilation_specific_flow_array, convective_internal_gains, radiative_internal_gains, internal_temperatures_dict, flow_array):
